package admin.acceptedTableview;
...
public class AcceptedTableViewController implements Initializable{
...
//                String n=
    ...
    public void initialize(URL location, ResourceBundle resource){
        ...
        try {
            ...
            //get students who have been accepted by the admin
            ...
            Logger.getLogger(AcceptedTableViewController.class.getName()).log(Level.SEVERE, null, ex);
        }
